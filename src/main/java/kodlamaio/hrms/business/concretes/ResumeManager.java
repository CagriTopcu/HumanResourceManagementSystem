...
public class ResumeManager implements ResumeService {
    ...
    @Override
    public DataResult<List<Resume>> getAllById(int id) {
        return new SuccessDataResult<List<Resume>>(this.resumeDao.findById(id).stream().toList());
    }

    @Override
    public DataResult<List<Resume>> findByResumeId(int id) {
        return new SuccessDataResult<List<Resume>>(this.resumeDao.findByCandidateId(id), "Başarıyla listelendi");
    }
